...
namespace Product.Application.Application.Features.Products.Queries.GetAllPaged
{
    ...
    internal class GetAllProductsQueryHandler : IRequestHandler<GetAllProductsQuery, PaginatedResult<GetAllPagedProductsResponse>>
    {
        ...
        {
            Expression<Func<Domain.Entities.Product, GetAllPagedProductsResponse>> expression = e => new GetAllPagedProductsResponse
            {
                Id = e.Id,
                Name = e.Name,
            ...
            {
                var data = await _unitOfWork.Repository<Domain.Entities.Product>().Entities
